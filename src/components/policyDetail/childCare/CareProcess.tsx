    ...
    <main>
      ...
      <div className="bg-white border-r-2 border-b-2 border-slate-300 py-[3rem] px-[1rem] sm:px-[3rem] lg:px-[6rem] drop-shadow-[0_1.5rem__1.5rem_rgba(0,0,0,0.05)] mb-[2rem] rounded-[1rem] flex flex-col justify-start">
        ...
        <text className="text-base lg:text-lg font-normal leading-8 lg:leading-8 pt-3">
          ...
          경감, 출발선상 공정 기회 보장 및 건강한 성장 발달 지원
          <br />
          만 3-5세 보육 · 교육과정 통합
          <br />
          어린이집과 유치원으로 이원화되어 있는 교육 · 보육과정을 “누리과정”으로
          통합
          <br />
          유아기에 필요한 기본 소양, 자율성과 창의성 및 바른 인성을 기르고
          전인발달을 이루도록 구성 · 적용
          <br />
          보육 · 교육비용 부담 경감
          <br />
          소득하위 70%에게만 지원하던 보육료 지원을 부모의 소득수준에 관계없이
          만 5세아(2012년 3월부터) 및 만 3-4세아(2013년 3월부터) 전계층으로 확대
          <br />
          어린이집에 만 3-5세 자녀를 보내는 모든 부모에 대해 보육료·유아학비
        ...
        <text className="text-base lg:text-lg font-normal leading-8 lg:leading-8 pt-3">
          ...
          민주시민의 기초를 형성하는 것을 목적으로 구성
          <br />
          질서, 배려, 협력 등 기본생활습관과 바른 인성을 기르고 자율성과
          창의성을 기르는 데 중점을 두고 전인발달을 이루도록 구성
          <br />
          사람과 자연을 존중하고, 우리 문화를 이해하는 데 중점을 두어
          구성하였으며 만 3-5세아의 발달 특성을 고려하여 구성
          <br />
          초등학교 교육과정과 0-2세 표준보육과정의 연계성을 고려하여 구성
          <br />
          ‘3-5세 누리과정‘은 신체운동·건강, 의사소통, 사회관계, 예술경험,
          자연탐구의 5개 영역을 중심 으로 구성
          <br />
          2012년 3월부터 모든 만 5세를 대상으로 어린이집 보육료와 유치학비를
          지원하고 있으며, 2013년 3월부터 그 대상을 만 3-4세까지 확대
          <br />
          <br />
          ※ 지원대상(2020년)
          <br />
        ...
        <text className="text-base lg:text-lg font-normal leading-8 pt-3">
          ...
          실질적으로 경감 <br />
          만 3-5세 유아의 질 높은 공통과정 적용 및 초등학교 교육과정과 0-2세
          표준보육과정의 연계성 강화 <br />
        </text>
      </div>
    </main>

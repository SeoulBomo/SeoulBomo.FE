  ...
  return (
    <main>
      ...
      <div className=" bg-yellowColor rounded-[0.7rem] w-[18.9rem] h-[5.6rem] flex items-center justify-center mt-[6rem] mb-[4rem]">
        <text className="font-bold text-2xl">보육지원체계 개편</text>
      </div>
      ...
      <div className=" bg-white w-[70rem] py-[2rem] pl-[1rem] drop-shadow-[0_1.5rem__1.5rem_rgba(0,0,0,0.05)] mb-[2rem] rounded-[1rem] flex flex-col">
        <text className="text-2xl font-semibold">주요내용</text>
          ...
          <table className=" text-lg text-left text-gray-500 mt-[1.5rem] ">
            <thead className="text-lg text-gray-700  bg-gray-100 ">
              <tr>
                <th
                  scope="col"
                  className="px-4 py-5  border-b-2 border-slate-200 text-center"
                  colSpan={2}
                >
            ...
            <tbody>
              <tr>
                <td className="text-lg text-gray-700 px-10 py-5 bg-white border-r-2 border-slate-200 border-b-2  ">
                  영유아 : 낮 근무로 피로한 당번교사가 아니라 <br />
                  고정된 전담교사가 돌봄으로써 안정감 및 보육질 향상
                </td>
                <td className="text-lg text-gray-700 px-10 py-5 bg-white border-b-2 border-slate-200">
                  부모 : 연장 보육이 필요한 부모가 안정적으로 연장 보육 서비스
                  이용
                </td>
              </tr>
              <tr>
                <td className="text-lg text-gray-700 px-10 py-5 bg-white border-r-2 border-slate-200 ">
                  어린이집 : 장시간 보육 운영 부담 완화
                </td>
                <td className="text-lg text-gray-700 px-10 py-5 bg-white">
                  교사 : 업무 부담 및 근무 환경 개선
                </td>
              </tr>
            </tbody>
        ...
        <text className="text-2xl font-semibold pt-[5rem]">
          0~2세반 연장보육 자격 기준 안내
        </text>
        <text className="text-xl font-medium pt-4">배경</text>
        <text className="text-lg font-normal leading-8 pt-1">
          ’20년 보육지원체계 개편에 따른 연장보육 자격 기준에 대한 <br />
          지자체 및 부모의 이해도를 높여 0~2세반 연장보육 자격 신청의 편의 도모
          필요
        </text>
        <text className="text-xl font-medium pt-4">
          0∼2세반 연장보육 자격 기준
        </text>
        <text className="text-lg font-normal leading-8 pt-1">
        ...
        <text className="text-xl font-medium pt-5">
        ...
        <section className="mt-[4rem]">
          ...
          <table className=" text-lg text-left text-gray-500 mt-[1.5rem] ">
            <thead className="text-lg text-gray-700  bg-gray-100 text-center">
              <tr>
        ...
        <section className="mt-[4rem]">
          ...
          <table className=" text-lg text-left text-gray-500 mt-[1.5rem] ">
            <thead className="text-lg text-gray-700  bg-gray-100 text-center"></thead>
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                <td
                  rowSpan={9}
                  className="px-4 py-4 bg-white border-r-2 border-b-2 border-slate-200"
                >
                  취업
                </td>
                <td
                ...
                <td className="px-4 py-4 bg-white border-r-2 border-b-2 border-slate-200">
                  건강보험, 고용보험
                </td>
                <td className="px-4 py-4 bg-white border-r-2 border-b-2 border-slate-200">
                  시스템 연계
              ...
              <tr>
                ...
                <td className="px-4 py-4 bg-white border-r-2 border-b-2 border-slate-200"></td>
              </tr>
              <tr>
                <td
                  colSpan={3}
              ...
              <tr>
                <td
                  colSpan={4}
                  className="px-4 py-4 bg-white border-r-2  border-slate-200"
                >
                  기타
                </td>
                <td className="px-4 py-4 bg-white border-r-2  border-slate-200">
                  연장보육
                  <br /> 신청 사유서
                </td>
                <td className="px-4 py-4 bg-white border-r-2  border-slate-200">

...
export default function PolicyReform() {
  return (
    <main>
      ...
      <div className="bg-white shadow-md lg:py-[3rem] px-[1rem] sm:px-[3rem] lg:px-[6rem] drop-shadow-[0_1.5rem__1.5rem_rgba(0,0,0,0.05)] mb-[2rem] rounded-[1rem] flex flex-col justify-start">
          ...
          <table className="text-base lg:text-lg text-left text-gray-500 mt-[1.5rem] ">
            <thead className="text-base lg:text-lg text-gray-700  bg-gray-100 ">
              <tr>
                <th
                  scope="col"
                  className="lg:px-4 py-5  border-b border-slate-200 text-center"
                  colSpan={2}
                >
        ...
        <section className="mt-[4rem]">
          ...
          <table className="text-base lg:text-lg text-left text-gray-500 mt-[1.5rem]">
            <thead className="text-base lg:text-lg text-gray-700  bg-gray-100 text-center">
              <tr>
                <th scope="col" className="lg:px-4 py-3" colSpan={2}>
                  자격구분
                </th>
                <th scope="col" className="lg:px-4 py-3">
                  종일반 자격(~’20.2월)
                </th>
                <th scope="col" className="lg:px-4 py-3 ">
                  연장보육 자격(’20.3월~)
            ...
            <tbody>
              <tr className="bg-white border-b">
                <td className="lg:px-4 lg:py-4 bg-gray-100" colSpan={2}>
                  단시간근로자
                  <br />
                  (주 15시간 미만)
                </td>
                <td className="lg:px-4 lg:py-4">신설</td>
              ...
              <tr className="bg-white border-b">
                ...
                <td className="lg:px-4 lg:py-4">신설</td>
                <td className="lg:px-4 lg:py-4">예술활동증명확인서</td>
              </tr>
              <tr className="bg-white border-b">
                <td className="lg:px-4 lg:py-4 bg-gray-100" rowSpan={3}>
                  구직자
                </td>
                <td className="lg:px-4 lg:py-4 bg-gray-100">구직등록</td>
                <td className="lg:px-4 lg:py-4">
                  구직등록확인증 + 구직활동 증빙 (1회 한정)
                </td>
                <td className="lg:px-4 lg:py-4">구직등록확인증(1회 한정)</td>
              </tr>
              <tr className="bg-white border-b">
                <td className="lg:px-4 lg:py-4 bg-gray-100">학원 수강</td>
                <td className="lg:px-4 lg:py-4">신설</td>
                <td className="lg:px-4 lg:py-4">학원수강증 (1회 한정)</td>
              </tr>
              <tr className="bg-white border-b">
                <td className="lg:px-4 lg:py-4 bg-gray-100">구직활동</td>
                <td className="lg:px-4 lg:py-4">신설</td>
                <td className="lg:px-4 lg:py-4">
              ...
              <tr className="bg-white border-b">
                <td className="lg:px-4 lg:py-4 bg-gray-100" rowSpan={2}>
                  학업
                </td>
                <td className="lg:px-4 lg:py-4 bg-gray-100">재학</td>
                <td className="lg:px-4 lg:py-4">
                  재학증명서, 연구생증명서 * <br />
                  방통대, 사이버대 등 원격대학 제외
                </td>
              ...
              <tr className="bg-white border-b">
                <td className="lg:px-4 lg:py-4 bg-gray-100">학위과정</td>
                <td className="lg:px-4 lg:py-4">신설</td>
                <td className="lg:px-4 lg:py-4">
                  논문심사의뢰서
                  <br />
              ...
              <tr className="bg-white border-b">
                ...
                <td className="lg:px-4 lg:py-4">연장보육 신청 사유서</td>
              </tr>
            </tbody>
          </table>
        </section>
          ...
          <table className="text-base lg:text-lg text-left text-gray-500 mt-[1.5rem]">
            ...
            <thead>
              <tr>
                <th
                  scope="col"
                  colSpan={4}
                  className="lg:px-4 lg:py-4 bg-gray-100"
                >
                  연장반 자격기준
                </th>
                <th scope="col" className="lg:px-4 lg:py-4 bg-gray-100">
                  증빙자료
                </th>
                <th scope="col" className="lg:px-4 lg:py-4 bg-gray-100">
                  자격 책정
            ...
            <tbody>
              <tr>
                <td
                  rowSpan={9}
                  className="lg:px-4 lg:py-4 bg-gray-100 border-r-2 border-b border-slate-200"
                >
                  취업
                </td>
                <td
                  rowSpan={2}
                  className="lg:px-4 lg:py-4 bg-white border-r-2 border-b border-slate-200"
                >
                  임금 근로자 (주 15H 이상)
                </td>
                <td
                ...
                <td className="lg:px-4 lg:py-4 bg-white border-r-2 border-b border-slate-200">
                  건강보험, 고용보험
                </td>
                <td className="lg:px-4 lg:py-4 bg-white border-r-2 border-b border-slate-200">
                  시스템 연계
              ...
              <tr>
                ...
                <td className="lg:px-4 lg:py-4 bg-white border-r-2 border-b border-slate-200"></td>
              </tr>
              <tr>
                <td
                  colSpan={3}

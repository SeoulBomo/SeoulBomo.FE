  ...
  return (
    <main>
      ...
      <div className=" bg-yellowColor rounded-[0.7rem] w-[18.9rem] h-[5.6rem] flex items-center justify-center mt-[6rem] mb-[4rem]">
        <text className="font-bold text-2xl">가정양육수당</text>
      </div>
      ...
      <div className="  bg-white border-r-2 border-b-2 border-slate-300 w-[70rem] py-[2rem] pl-[1rem] drop-shadow-[0_1.5rem__1.5rem_rgba(0,0,0,0.05)] mb-[2rem] rounded-[1rem] flex flex-col">
        <text className="text-2xl font-semibold">가정양육수당</text>
        ...
        <section>
          <table className=" text-md text-left text-gray-500  px-3 py-3 mt-[1rem]">
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                <td className="text-md text-gray-700   bg-white border-r-2 border-b-2 border-slate-300 px-3 py-3">
                  0~11
                </td>
                <td className="text-md text-gray-700   bg-white border-r-2 border-b-2 border-slate-300 px-3 py-3">
                  200천원
                ...
                <td
                  rowSpan={3}
                  className="text-md text-gray-700   bg-white border-r-2 border-b-2 border-slate-300 px-3 py-3"
                >
                  0~35
                </td>
                <td

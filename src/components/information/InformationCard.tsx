    ...
    <section className="bg-white mb-[5rem] rounded-[1.25rem] drop-shadow-xl md:px-[5rem] p-[3rem]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mt-[3rem]">
        {data?.map((item: any) => (
          <div
            key={item.id}
            className="w-[15rem] sm:w-[25rem] h-[4.1rem] rounded-[10px] bg-amber-200 font-semibold text-lg md:text-2xl flex items-center hover:translate-x-3 ease-in-out duration-300"
          >
